...
class User(Base):
    ...
    Attributes:
        ...
        assigned_incidents (List[Incident]): Relationship to incidents assigned to this user.
        incident_comments (List[IncidentComment]): Relationship to comments made by this user.
    """
    __tablename__ = "users"
