...
- CIC-IDS2017 veri seti kaynağının incelenmesi
- MachineLearningCSV dosyalarının analizi
- Sütun ve hedef değişken incelemesi
- Sınıf dağılımı analizi
- Küçük geliştirme örneklemi oluşturma (Gün 6'ya ertelendi)
...
- Upload testleri
- Küçük geliştirme örneklemi (sentetik/küçük test dosyası) oluşturulması (Gün 2'den ertelenen çalışma)
...
Ana veri seti olarak **CIC-IDS2017** kullanılmaktadır.

- Kaynak: [CIC-IDS2017 Dataset (Canadian Institute for Cybersecurity - UNB)](https://www.unb.ca/cic/datasets/ids-2017.html)
- Resmî CSV Dosyaları: `data/raw/` klasörü altındaki 8 adet resmî CSV dosyası (MachineLearningCSV).
